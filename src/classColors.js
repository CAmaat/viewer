...
function classColorsCodes()
{
    var out = [
        ...
        {className: 'Astro.1',                      IdentifiedType: 'Non Neuron',         color: '#0377fc'},
        {className: 'Astro.2',                      IdentifiedType: 'Non Neuron',         color: '#0377fc'},
        {className: 'Astro.3',                      IdentifiedType: 'Non Neuron',         color: '#0377fc'},
        {className: 'Astro.4',                      IdentifiedType: 'Non Neuron',         color: '#0377fc'},
        {className: 'Astro.5',                      IdentifiedType: 'Non Neuron',         color: '#0377fc'},
        ...
        {className: 'Microglia.1',                  IdentifiedType: 'Non Neuron',         color: '#DD2BDA'},
        {className: 'Microglia.2',                  IdentifiedType: 'Non Neuron',         color: '#DD2BDA'},
        {className: 'Oligo.1',                      IdentifiedType: 'Non Neuron',         color: '#fcc603'},
        {className: 'Oligo.2',                      IdentifiedType: 'Non Neuron',         color: '#fcc603'},
        {className: 'Oligo.3',                      IdentifiedType: 'Non Neuron',         color: '#fcc603'},
        {className: 'Oligo.4',                      IdentifiedType: 'Non Neuron',         color: '#fcc603'},
        {className: 'Oligo.5',                      IdentifiedType: 'Non Neuron',         color: '#fcc603'},
